...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'hr-manager', 'employee', 'payroll-manager', 'system-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Exits', path: '/exits', entity: 'exit', service: AccessServiceEnum.PROJECT, icon: FiLogOut },
    {
      name: 'Onboardings',
      path: '/onboardings',
      entity: 'onboarding',
